...
export default function UploadFile({ buttonLabel, formLabel, CustomButton, handleSubmit, customButtonClass }) {
    ...
    <>
      ...
      <div className={`${isOpen ? "block" : "hidden"} z-40 fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2`}>
        ...
        >
          ...
          <FileInput setFormData={setFormData} setIsOpen={setIsOpen} />
        </form>
      </div>
    </>
  );
